...
// https://esp32tutorials.com/esp32-esp-idf-freertos-semaphore-tutorial/
// Notes about the functions ( This is mostly for myself as a reminder):
// xSemaphoreCreateBinary() creates a binary semaphore
// xSemaphoreGive() Realeases a binary semaphore so other tasks can use it
